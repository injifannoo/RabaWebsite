  ...
  return (
    <div className="bg-white w-full text-secondary font-custom min-h-screen">
      <div className="max-w-[1200px] m-auto px-6 py-10">
        <h1 className="text-4xl font-bold text-black mb-6">Gizachew Haptamariam</h1>
        <div className="flex flex-col md:flex-row items-center md:items-start">
          {/* Profile Picture Section */}
          <div className="md:w-1/3 flex justify-center md:justify-start mb-6 md:mb-0">
            <img
              src="https://via.placeholder.com/150" // Replace with the actual image of Gizachew
              alt="Gizachew Tamiru Urgessa"
          ...
          <div className="md:w-2/3 md:pl-8">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Gizachew Haptamariam is a visionary co-founder and skilled software developer with
            ...
            <p className="mt-4 text-gray-600">
              With a passion for solving real-world problems through technology, Gizachew brings
