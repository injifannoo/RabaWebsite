...
const HomePage = () => {
  ...
  return (
    <div className="w-full h-screen bg-cover bg-center mt-0"
      ...
      <div className="flex flex-col w-full h-full bg-black bg-opacity-50 px-24 items-start justify-start pt-40">
        ...
        <h1 className="text-5xl font-extrabold leading-tight">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-orange-400 ml-4">
             Technologies
          </span>
        </h1>
        ...
        <p className="text-white text-xl max-w-2xl mt-5 mb-6 leading-relaxed font-serif tracking-wide shadow-lg opacity-90 transition-all duration-300 hover:opacity-100 hover:shadow-xl">
